      ...
      <transition name="fade-up" appear>
        ...
        <div v-if="!isMobile" class="tabs">
          <div class="tabs__header">
            <div class="tabs__item" :class="{ 'tabs__item--active': activeTab === index }" v-for="(item, index) in exerciseTabsData"
              :key="index" @click="selectTab(index)">
              {{ item.title }}
            </div>
          </div>
          <div class="tabs__content" v-html="exerciseTabsData[activeTab].content">
          </div>
        </div>
        <!-- Mobile Accordion -->
        <div v-else class="accordion">
          <div class="accordion__item" v-for="(item, index) in exerciseTabsData" :key="index">
            ...
            <div class="accordion__content" :class="{ 'accordion__content--active': isActive(index) }">
